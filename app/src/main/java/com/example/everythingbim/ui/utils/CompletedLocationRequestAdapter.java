...
public class CompletedLocationRequestAdapter
        extends RecyclerView.Adapter<CompletedLocationRequestAdapter.ViewHolder> {

    private List<DocumentSnapshot> requests;
    private int itemLayoutRes;

    public CompletedLocationRequestAdapter(List<DocumentSnapshot> requests, int itemLayoutRes) {
