...
public class CompletedInfoRequestAdapter
        extends RecyclerView.Adapter<CompletedInfoRequestAdapter.ViewHolder> {

    private List<DocumentSnapshot> requests;
    private int itemLayoutRes;

    public CompletedInfoRequestAdapter(List<DocumentSnapshot> requests, int itemLayoutRes) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Reason
        String reasonValue = doc.getString("reason");
        Log.d("CompletedInfoAdapter", "Position " + position + ", reason: '" + reasonValue + "'");
        if (holder.reason != null) {
            holder.reason.setText(reasonValue != null ? reasonValue : "EMPTY");
        }
