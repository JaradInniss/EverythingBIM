...
public class AddLocationRequestFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        // Bind views
        formScrollView      = view.findViewById(R.id.add_location_request_scroll);
    ...
    private void showAuthRequiredDialog() {
        new AlertDialog.Builder(requireContext())
                ...
                .setMessage("Guests can explore the app, but you'll need an account before submitting a location request.")
                .setPositiveButton("Log In", (dialog, which) -> {
                    Intent intent = new Intent(requireContext(), Login.class);
                    intent.putExtra(MainActivity.EXTRA_PENDING_ACTION, MainActivity.ACTION_ADD_LOCATION_REQUEST);
