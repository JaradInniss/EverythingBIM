...
public class AddInformationRequestFragment extends Fragment {
    private static final String PREF_ADD_INFORMATION_SCROLL_HINT_SEEN = "add_information_scroll_hint_seen";
    ...
    private void setupKeyboardInsets(View root) {
        View scrollContainer = root.findViewById(R.id.add_inforeq_scroll);
