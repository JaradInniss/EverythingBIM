...
public class InfoRequestAdapter
        extends RecyclerView.Adapter<InfoRequestAdapter.ViewHolder> {

    private List<DocumentSnapshot> requests;
    private int itemLayoutRes;

    public InfoRequestAdapter(List<DocumentSnapshot> requests, int itemLayoutRes) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Place type
        String placeTypeValue = doc.getString("placeType");
        Log.d("InfoRequestAdapter", "Position " + position + ", placeType: '" + placeTypeValue + "'");
        if (holder.placeType != null) {
            holder.placeType.setText(placeTypeValue != null ? placeTypeValue : "EMPTY");
        }

        // Reason (only exists in completed layout)
        if (holder.reason != null) {
            holder.reason.setText(doc.getString("reason"));
        }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView locationName, locationDesc, placeType, reason;
        MapView mapView;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            locationName = itemView.findViewById(R.id.viewinforeq_name_et);
            locationDesc = itemView.findViewById(R.id.viewinforeq_desc_et);
            placeType = itemView.findViewById(R.id.viewinforeq_place_type_et);
            reason = itemView.findViewById(R.id.viewinforeq_reason_et);
            mapView = itemView.findViewById(R.id.viewinforeq_map);
            imageContainer = itemView.findViewById(R.id.viewinforeq_image_container);
            acceptedContainer = itemView.findViewById(R.id.viewinforeq_accepted_container);
            rejectedContainer = itemView.findViewById(R.id.viewinforeq_rejected_container);
            acceptedDate = itemView.findViewById(R.id.viewinforeq_accepted_date_tv);
            acceptedBy = itemView.findViewById(R.id.viewinforeq_accepted_by_tv);
            rejectedDate = itemView.findViewById(R.id.viewinforeq_rejected_date_tv);
            rejectedBy = itemView.findViewById(R.id.viewinforeq_rejected_by_tv);
            rejectionReason = itemView.findViewById(R.id.viewinforeq_rejection_reason_tv);
        }
    }
}